...
?>
	...
	<?php if ( have_comments() ) : ?>
		<p>IMPORTANT: All messages older than 7 days will be deleted</p>
	...
	$defaults = array(
		...
		'id_form'              => 'commentform',
		'id_submit'            => 'submit',
		'title_reply'          => apply_filters( 'generate_leave_comment', __( 'Leave a Message','generatepress' ) ),
		...
		'label_submit'         => apply_filters( 'generate_post_comment', __( 'Post Message','generatepress' ) ),
	);
