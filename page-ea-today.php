<?php /* Template Name: Today's EAs */ ?>
<?php
/**
 * The template for displaying todays eas.
 *
...
<?php wp_redirect( 'http://perthreliefteachers.com.au/ea-days/01-monday', 302 ); exit; ?>
<?php } elseif ($currentday == Tuesday){ ?>
<div class="day-title">Tuesday</div>
<?php wp_redirect( 'http://perthreliefteachers.com.au/ea-days/02-tuesday', 302 ); exit; ?>
<?php } elseif ($currentday == Wednesday){ ?>
<div class="day-title">Wednesday</div>
<?php wp_redirect( 'http://perthreliefteachers.com.au/ea-days/03-wednesday', 302 ); exit; ?>
<?php } elseif ($currentday == Thursday){ ?>
<div class="day-title">Thursday</div>
<?php wp_redirect( 'http://perthreliefteachers.com.au/ea-days/04-thursday', 302 ); exit; ?>
<?php } elseif ($currentday == Friday){ ?>
<div class="day-title">Friday</div>
<?php wp_redirect( 'http://perthreliefteachers.com.au/ea-days/05-friday', 302 ); exit; ?>
