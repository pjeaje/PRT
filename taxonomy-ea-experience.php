...
<p>These education assistants available to work in <?php single_term_title(); ?> schools.</p>
	<?php if ( is_user_logged_in() && (current_user_can('school-cap') || current_user_can('admin-cap'))) { ?>
...
<p>If you are a school relief co-ordinator you can <a href="http://perthreliefteachers.com.au/login-school">Login</a> and <a href="http://perthreliefteachers.com.au/login-school">register</a> to find education assistants available to work within <?php single_term_title(); ?> schools. This includes mainstream, special needs, ethnic and Aboriginal/Islander EAs.</p>
<?php } elseif (is_user_logged_in() && (current_user_can('teacher-cap') || current_user_can('ea-cap')) ) { ?>
<p>If you are an education assistant willing to work at schools within <?php single_term_title(); ?> schools, please <a href="http://perthreliefteachers.com.au/ea-profile">update your availability</a> to reflect this.</p>			
<?php } ?>
		</header><!-- .entry-header -->
	</div><!-- .inside-article -->
</article><!-- #post-## -->		
